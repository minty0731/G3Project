...
const ProfilePage: React.FC = () => {
    return (
        <div className="flex flex-col items-center justify-center px-24 py-12 mb-10 h-full w-full">
            <div className="flex items-start w-full text-xl font-bold mb-5"><h3>Thông tin cá nhân</h3></div>
            {/*Beginning of user information*/}
            <div className="flex flex-col h-full w-full border rounded-md border-black ">
            ...
            {/*Ending of user account*/}
            <div className="flex items-start w-full mb-5 text-xl font-bold my-10"><h3>Shop yêu thích</h3></div>
            <StoreSlider />
        </div>
