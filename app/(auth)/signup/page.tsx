        ...
        <div className="flex items-center justify-center h-[52rem] ">
            <div className="flex w-full h-full">
                ...
                <div className="w-2/3 flex flex-col items-center justify-center bg-white">
                    ...
                    <form onSubmit={handleSignupSubmit} className="w-full max-w-md p-8 bg-white border-2 border-gray-500 rounded">
                        <h2 className="text-2xl text-center font-bold mb-6">Đăng ký</h2>
                        <div className="mb-4">
                            <input
                                id="email"
                                type="email"
                        ...
                        <div className="flex items-center justify-center w-full space-x-2 mt-5">
                            ...
                            <h1 className="text-md font-medium">Hoặc đăng ký bằng</h1>
                            <div className="h-[1px] bg-black flex-1"></div>
                        </div>
